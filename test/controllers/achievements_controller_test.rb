...
class AchievementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create achievement" do
    assert_difference("Achievement.count") do
      post achievements_url, params: { achievement: { concluded_at: @achievement.concluded_at, subject_id: @achievement.subject_id, subscription_id: @achievement.subscription_id } }
    end
  ...
  test "should update achievement" do
    patch achievement_url(@achievement), params: { achievement: { concluded_at: @achievement.concluded_at, subject_id: @achievement.subject_id, subscription_id: @achievement.subscription_id } }
